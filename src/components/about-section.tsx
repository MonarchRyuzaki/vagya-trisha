      ...
      <div className="container mx-auto px-4 md:px-6 grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="space-y-4 text-center lg:text-left">
          ...
          <p className="max-w-[600px] mx-auto lg:mx-0 text-foreground/80 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed font-body">
            With over two decades of experience studying the astrological arts, I am dedicated to providing insightful and compassionate guidance. My journey began with a deep fascination for the cosmos and its influence on our lives. I blend ancient wisdom with modern psychological principles to offer readings that are not only accurate but also deeply transformative. My mission is to empower you to navigate life's challenges and seize its opportunities with confidence and clarity.
          </p>
        </div>
      </div>
    </section>
